...
public abstract class SearchEngineContractTest {
  ...
  @Test
  public void deleteOneDocumentById(){

    store(new User(1l, "John"));

    searchEngine.deleteDocuments(User.class, Lists.newArrayList(1l));
  ...
  @Test
  public void deleteMoreThanOneDocumentByIds(){

    store(new User(1l, "John"));
    store(new User(2l, "John"));

    searchEngine.deleteDocuments(User.class, Lists.newArrayList(1l, 2l));
